...
export const AboutMe = () => {
  const lId = {
    title: 'Tentang Saya',
    part_one: 'Halo!',
    part_two: 'Saya seorang Software Engineer dengan pengalaman dalam mengembangkan aplikasi dari sisi Back-end dan Front-end, untuk platform Web maupun Mobile. Terbiasa bekerja dengan framework modern seperti Flutter, Next.js, dan Node.js. Memiliki pemahaman yang baik tentang arsitektur aplikasi, RESTful API, serta pengelolaan basis data.',
